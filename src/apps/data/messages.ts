...
export const messages = [
    ...
    views: 1000},
  {
    ...
    status: 'read'},
  {
    chatId: 1, dialogId: 'dlg_43543555', type: "message.image",
    url: "https://picsum.photos/seed/chotto-mountains/1200/800",
    imagePreviewUrl: "https://picsum.photos/seed/chotto-mountains/400/300",
    items: [
      { url: "https://picsum.photos/seed/chotto-mountains/1200/800", imagePreviewUrl: "https://picsum.photos/seed/chotto-mountains/400/300", filename: "mountains.jpg", size: 245760 },
      { url: "https://picsum.photos/seed/chotto-lake/1200/800", imagePreviewUrl: "https://picsum.photos/seed/chotto-lake/400/300", filename: "lake.jpg", size: 198400 },
      { url: "https://picsum.photos/seed/chotto-forest/1200/800", imagePreviewUrl: "https://picsum.photos/seed/chotto-forest/400/300", filename: "forest.jpg", size: 210000 },
    ],
    text: "Фото с поездки",
    timestamp: '1727027960',
    alt: "Горы", direction: 'outgoing',
    header: 'Вы',
    views: 12, messageId: '4a',
    status: 'read'},
    {
...
//=========================================================================================================================================================================================//
  ...
  },
  {
    ...
    messageId: '617',
    type: "message.text",
    text: "Уважаемые Алексей и Марина, благодарим вас за оперативную подготовку обновлённой версии макетов (v.2.1). Мы провели внутренний ревью с маркетингом, продуктом и юзабилити-командой — в целом прогресс заметен, и многие замечания из предыдущей итерации учтены. Однако остаются важные моменты, которые необходимо доработать до финального согласования. Прошу вас внимательно ознакомиться с перечнем правок ниже. Для удобства я разделила их по разделам и приоритетам. Также прикрепляю PDF с аннотациями — там вы найдёте визуальные пояснения к каждому пункту. Уважаемые Алексей и Марина, благодарим вас за оперативную подготовку обновлённой версии макетов (v.2.1). Мы провели внутренний ревью с маркетингом, продуктом и юзабилити-командой — в целом прогресс заметен, и многие замечания из предыдущей итерации учтены. Однако остаются важные моменты, которые необходимо доработать до финального согласования. Прошу вас внимательно ознакомиться с перечнем правок ниже. Для удобства я разделила их по разделам и приоритетам. Также прикрепляю PDF с аннотациями — там вы найдёте визуальные пояснения к каждому пункту.",
    direction: 'outgoing',
    status: 'received',
  ...
  },
  {
    ...
    subText: 'Анна',
    imagePreviewUrl: 'https://sun9-15.userapi.com/s/v1/ig2/5ifa4RILacLTvbXHM0E0gmPbfhYCjoFo1s4J7IhNXL55aetwIIzUga_VLT9IX1yNswsXnPZ-6x3kHRRnYIIo98xE.jpg?quality=95&as=32x48,48x72,72x108,108x162,160x240,240x360,360x540,480x720,540x810,640x960,720x1080,740x1110&from=bu&cs=360x0',
    items: [
      {
        url: 'https://sun9-15.userapi.com/s/v1/ig2/5ifa4RILacLTvbXHM0E0gmPbfhYCjoFo1s4J7IhNXL55aetwIIzUga_VLT9IX1yNswsXnPZ-6x3kHRRnYIIo98xE.jpg?quality=95&as=32x48,48x72,72x108,108x162,160x240,240x360,360x540,480x720,540x810,640x960,720x1080,740x1110&from=bu&cs=740x0',
        imagePreviewUrl: 'https://sun9-15.userapi.com/s/v1/ig2/5ifa4RILacLTvbXHM0E0gmPbfhYCjoFo1s4J7IhNXL55aetwIIzUga_VLT9IX1yNswsXnPZ-6x3kHRRnYIIo98xE.jpg?quality=95&as=32x48,48x72,72x108,108x162,160x240,240x360,360x540,480x720,540x810,640x960,720x1080,740x1110&from=bu&cs=360x0',
      ...
      {
        url: 'https://sun9-26.userapi.com/s/v1/ig2/MUXBjbo1JtVSfo4XfEryXXqAHwU8S6HJAw1dwQL_JbSwEpwIHOrU2wg6JcFrTbE9s00WEDLWnqK0UpCfPNt6Up9T.jpg?quality=95&as=32x18,48x27,72x40,108x60,160x89,240x134,360x201,480x268,540x301,640x357,720x402,1080x603,1280x714,1376x768&from=bu&cs=1376x0',
        imagePreviewUrl: 'https://sun9-26.userapi.com/s/v1/ig2/MUXBjbo1JtVSfo4XfEryXXqAHwU8S6HJAw1dwQL_JbSwEpwIHOrU2wg6JcFrTbE9s00WEDLWnqK0UpCfPNt6Up9T.jpg?quality=95&as=32x18,48x27,72x40,108x60,160x89,240x134,360x201,480x268,540x301,640x357,720x402,1080x603,1280x714,1376x768&from=bu&cs=360x0',
        filename: 'landscape.jpg',
      },
      {
        url: 'https://nationaltoday.com/wp-content/uploads/2022/05/Sun-Day--1200x834.jpg',
        imagePreviewUrl: 'https://nationaltoday.com/wp-content/uploads/2022/05/Sun-Day--1200x834.jpg',
        filename: 'sun.jpg',
      },
      {
        url: 'https://sun9-15.userapi.com/s/v1/ig2/5ifa4RILacLTvbXHM0E0gmPbfhYCjoFo1s4J7IhNXL55aetwIIzUga_VLT9IX1yNswsXnPZ-6x3kHRRnYIIo98xE.jpg?quality=95&as=32x48,48x72,72x108,108x162,160x240,240x360,360x540,480x720,540x810,640x960,720x1080,740x1110&from=bu&cs=740x0',
  ...
  },
  {
    ...
    url: pdfFile,
    items: [
      { url: pdfFile, filename: 'Документ.pdf' },
  ...
  },
  {
    ...
    dialogId: 'dlg_43543111',
    type: "message.text",
    text: "Ещё одно сообщение до разделителя",
    direction: 'incoming',
    status: 'read',
