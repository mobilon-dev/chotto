...
import CheckIcon from '@/components/1_icons/CheckIcon.vue';
import WhatsAppIcon from '@/components/1_icons/WhatsAppIcon.vue';
import TelegramIcon from '@/components/1_icons/TelegramIcon.vue';
