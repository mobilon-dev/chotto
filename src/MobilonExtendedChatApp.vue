            ...
            <template #default>
              ...
              >
                ...
                >
                  ...
                  <template #actions>
                    <div style="display: flex">
                      ...
                      <button class="chat-info__button-panel" @click="handleOpenSearchPanel">
                ...
                <Feed
                  ...
                  :scroll-to-bottom="
                    scrollToBottomOnSelectChat || isScrollToBottomOnUpdateObjectsEnabled
                  "
                    ...
                    <SplashScreen>
                      ...
                      <template #text>
                        <span style="max-width: 300px; display: block"
                          >Вы можете отправить новое сообщение или воспользоваться шаблоном</span
                        >
                      </template>
                      <template #picture>
                        <img
            ...
            <template #chatpanel>
              <ChatPanel v-if="isOpenChatPanel" :title-enabled="false">
                <template #content>
                  <div>
                    {{ selectedChat.name }}
                    <button class="button-close" @click="isOpenChatPanel = !isOpenChatPanel">
...
<script setup>
  ...
  const setMessageClass = (message) => {
    if (message) {
      if (message.dialogId == 'dlg_89789879') return 'tg-message'
      else return 'wa-message'
    }
  }
    ...
    if (selectedChat.value && selectedChat.value.chatId == 5) {
      ...
      setTimeout(() => {
        ...
        if (messages1.length > 0) {
          ...
          if (
            additionalMessages[additionalMessages.length - 1].time == firstMessage.time &&
