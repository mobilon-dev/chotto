  ...
  <div>
    <BaseContainer height="90vh" width="70vw">
      <ExtendedLayout>
        ...
        <template #third-col>
          <chat-wrapper :is-open-chat-panel="isOpenChatPanel" :is-selected-chat="!!selectedChat">
            <template #default>
              ...
              />
              <ChatInput :focus-on-input-area="inputFocus" @send="addMessage">
                <template #buttons>
                  <FileUploader :filebump-url="filebumpUrl" :state="'disabled'" />
