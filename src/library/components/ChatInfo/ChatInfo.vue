<template>
  <div v-if="chat" class="chat-info__container">
    <div class="chat-info__base-line">
      ...
      <div class="chat-info__info-container">
        ...
        <p v-if="chatDescription" class="chat-info__time">
    ...
    <div :id="'chat-info-search-panel-' + chatAppId" class="chat-info__search-panel">
      <slot name="search" />
    </div>
  </div>
</template>
