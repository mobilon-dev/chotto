<template>
  ...
  >
    <span
      ...
      :class="{
        'file-uploader__disabled': !canUploadFile || state == 'disabled',
      }"
    />
  </ButtonContextMenu>
  <input
...
const { setMessageFile, resetMessageFile, getMessage, setRecordingMessage } =
...
const handleFileUpload = async (file: File) => {
  ...
  await uploadFile(f, file).then((data) => {
