...
const setThirdColVisible = () => {
  const container = document.getElementById(
    'extern-layout-container-' + chatAppId
  )

  container.style.setProperty(
    '--chotto-adaptive-extended-layout-second-col-display',
    'none'
  )
  container.style.setProperty(
    '--chotto-adaptive-extended-layout-third-col-display',
    'flex'
  )
  container.style.setProperty(
    '--chotto-adaptive-extended-layout-second-col-width',
    '0%'
  )
  container.style.setProperty(
    '--chotto-adaptive-extended-layout-third-col-width',
    '100%'
  )
}
...
onMounted(() => {
  ...
  const firstCol = document.getElementById(
    'extend-layout-first-col-' + chatAppId
  )

  container.style.setProperty(
    '--chotto-adaptive-extended-layout-first-col-width',
    firstCol.offsetWidth + 'px'
  )
})
</script>
